...
import { UserCircle, Wand2, Save, Upload, CalendarIcon, Users, Briefcase, Loader2, Sparkles, Trash2, ChevronDown, Settings2 } from 'lucide-react';
              ...
              <AccordionItem value="additional" className="border rounded-lg px-3">
                ...
                <AccordionContent className="pb-3 space-y-3">
                  ...
                  <div>
                    ...
                    <Button variant="outline" size="sm" onClick={handleGenerateBioClick} disabled={isGeneratingBio} className="mt-1 h-7 text-xs" type="button">
